...
extension UIColor {
    ...
    static let redBackground = UIColor(hexString: "db071e")
    static let buttonBackground = UIColor(hexString: "334955")
    static let grayTitle = UIColor(hexString: "555555")
    static let grayLink = UIColor(hexString: "7b7b7b")
    static let indicator = UIColor(hexString: "23ebf5")
    static let darkGray = UIColor(hexString: "666666")
    static let blackText = UIColor(hexString: "141414")
}
