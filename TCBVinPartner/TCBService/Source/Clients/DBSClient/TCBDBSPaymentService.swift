...
extension TCBDBSPaymentClient: TCBDBSPaymentService {
    ...
    func makePayment(paymentInfo: PaymentInfo, completion: @escaping TCBResponseCompletion<Balance>) {
        ...
        let postalAddress = BBPostalAddress(addressLine1: paymentInfo.receiverBankAddress, addressLine2: nil, streetName: nil, postCode: nil, town: nil, countrySubDivision: nil, country: paymentInfo.receiverBankCountry)
